...
assume -name variable_map_assume1 {(~ __START__ )|| (`true)}
...
assume -name variable_map_assume4 {(~ __START__ )|| (__m0__)}
assume -name variable_map_assume5 {(~ __START__ )|| (__m1__)}
assume -name variable_map_assume6 {(~ __START__ )|| (__m2__)}
...
assume -name additional_mapping_control_assume14 {(__ILA_SO_TXFIFO_BUFF == m1.core.txfifo.tx_f.mem}
assume -name issue_decode15 {(~ __START__) || (__ILA_TX_FIFO_decode_of_TX_WR_PKT_DATA_FIFO__)}
assume -name issue_valid16 {(~ __START__) || (__ILA_TX_FIFO_valid__)}
...
assert -name variable_map_assert2 {(~ __IEND__) || (__m3__)}
assert -name variable_map_assert3 {(~ __IEND__) || (__m4__)}
