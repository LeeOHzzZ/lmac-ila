...
assume -name variable_map_assume7 {(~ __START__ )|| (__m6__)}
assume -name variable_map_assume8 {(~ __START__ )|| (__m7__)}
assume -name variable_map_assume9 {(~ __START__ )|| (__m8__)}
assume -name variable_map_assume10 {(~ __START__ )|| (__m9__)}
assume -name variable_map_assume11 {(~ __START__ )|| (__m10__)}
assume -name variable_map_assume12 {(~ __START__ )|| (__m11__)}
assume -name variable_map_assume13 {(~ __START__ )|| (__m12__)}
assume -name variable_map_assume14 {(~ __START__ )|| (__m13__)}
assume -name variable_map_assume15 {(~ __START__ )|| (__m14__)}
assume -name variable_map_assume16 {(~ __START__ )|| (__m15__)}
assume -name variable_map_assume17 {(~ __START__ )|| (__m16__)}
assume -name variable_map_assume18 {(~ __START__ )|| (__m17__)}
assume -name variable_map_assume19 {(~ __START__ )|| (__m18__)}
assume -name variable_map_assume20 {(~ __START__ )|| (__m19__)}
...
assert -name variable_map_assert0 {(~ __IEND__) || (__m20__)}
assert -name variable_map_assert1 {(~ __IEND__) || (__m21__)}
assert -name variable_map_assert2 {(~ __IEND__) || (__m22__)}
assert -name variable_map_assert3 {(~ __IEND__) || (__m24__)}
assert -name variable_map_assert4 {(~ __IEND__) || (__m25__)}
assert -name variable_map_assert5 {(~ __IEND__) || (__m26__)}
assert -name variable_map_assert6 {(~ __IEND__) || (__m27__)}
assert -name variable_map_assert7 {(~ __IEND__) || (__m28__)}
assert -name variable_map_assert8 {(~ __IEND__) || (__m29__)}
assert -name variable_map_assert9 {(~ __IEND__) || (__m30__)}
assert -name variable_map_assert10 {(~ __IEND__) || (__m31__)}
assert -name variable_map_assert11 {(~ __IEND__) || (__m32__)}
assert -name variable_map_assert12 {(~ __IEND__) || (__m33__)}
