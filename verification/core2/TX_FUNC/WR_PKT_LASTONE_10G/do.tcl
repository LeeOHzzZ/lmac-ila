...
assume -name issue_decode30 {(~ __START__) || (__ILA_TX_FUNC_decode_of_WR_PKT_LASTONE_10G__)}
...
assert -name variable_map_assert0 {(~ __IEND__) || (__m21__)}
assert -name variable_map_assert1 {(~ __IEND__) || (__m22__)}
