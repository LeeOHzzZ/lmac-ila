...
assert -name variable_map_assert0 {(~ __IEND__) || (__m19__)}
assert -name variable_map_assert1 {(~ __IEND__) || (__m20__)}
assert -name variable_map_assert2 {(~ __IEND__) || (__m21__)}
assert -name variable_map_assert3 {(~ __IEND__) || (__m22__)}
