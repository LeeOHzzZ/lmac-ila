...
assume -name issue_decode31 {(~ __START__) || (__ILA_TX_FUNC_decode_of_WR_PKT_LASTONE_10G__)}
...
assert -name variable_map_assert2 {(~ __IEND__) || (__m19__)}
assert -name variable_map_assert3 {(~ __IEND__) || (__m20__)}
